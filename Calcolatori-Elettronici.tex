...
\begin{figure}[H]%
    \centering%
    \savebox{\tempbox}{\hbox{\includegraphics{nand-transistor.pdf}}}%
    \subfloat[\centering{Porta NOT}]{\raisebox{\dimexpr.5\ht\tempbox-.5\height\relax}{\includegraphics{not-transistor.pdf}}}%
    \qquad%
    \subfloat[\centering{Porta NAND}]{\usebox{\tempbox}}%
    \qquad%
    \subfloat[\centering{Porta NOR}]{\raisebox{\dimexpr.5\ht\tempbox-.5\height\relax}{\includegraphics{nor-transistor.pdf}}}%
...
\begin{figure}[H]%
    \centering%
    \subfloat[\centering{Livello Alto}]{\includegraphics{latch-compatti.pdf}}%
    \qquad%
    \subfloat[\centering{Livello Basso}]{\includegraphics{latch-compatti-alto.pdf}}%
...
\begin{figure}[H]%
    \centering%
    \subfloat[\centering{Fronte di Salita}]{\includegraphics{flip-flop-d-compatti.pdf}}%
    \qquad%
    \subfloat[\centering{Fronte di Discesa}]{\includegraphics{flip-flop-d-compatti-discesa.pdf}}%    
...
\begin{figure}[H]%
    ...
    \subfloat{%
        \includegraphics{bit-color-bus.pdf}%
    }
...
\begin{figure}[H]%
    \centering
    \subfloat{%
        \includegraphics{bus-asincrono.pdf}%
    }\\
    \subfloat{%
        \includegraphics{bit-color-bus.pdf}%
    }
