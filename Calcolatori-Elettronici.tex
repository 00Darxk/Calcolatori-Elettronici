...
prima persona che ha tentato di implementare il linguaggio di Babbage fu Ada. %% TODO cognome 
...
%% TODO flip flop d fronte di discesa
...
\begin{figure}[H]%
    \centering
    \includegraphics{processore-cisc-jvm.pdf}%
...
Si possono individuare quattro componenti fondamentali. %% TODO ppt. pg 82 
...
Infine l'unità di esecuzione esegue le microistruzioni %% TODO 
...
%% TODO microarchitettura specifiche
...
%% TODO tabella registri generali 8088
...
negativo, O se il risultato ha causato un overflow, C se il risultato ha creato un riporto, A, riporto ausiliario su 3 bit; P parità del risultato %% TODO finire registro di stato 
...
%% TODO modalità di indirizzamento tabella
...
%% TODO direttive ed etichette compilatore 
